...
namespace Aban.AppBack.Migrations
{
    ...
    [Migration("20260206164422_NewProductDB")]
    partial class NewProductDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aban.Domain.EntitesSoftSec.Usuario", b =>
                {
            ...
            modelBuilder.Entity("Aban.Domain.EntitesSoftSec.UsuarioRole", b =>
                {
            ...
            modelBuilder.Entity("Aban.Domain.Entities.Corporation", b =>
                {
                    b.Property<int>("CorporationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aban.Domain.Entities.Country", b =>
                {
                    b.Property<int>("CountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aban.Domain.Entities.Manager", b =>
                {
            ...
            modelBuilder.Entity("Aban.Domain.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Aban.Domain.Entities.UserRoleDetails", b =>
                {
            ...
            modelBuilder.Entity("Aban.Domain.EntitiesSoft.Product", b =>
                {
            ...
            modelBuilder.Entity("Aban.Domain.EntitesSoftSec.Usuario", b =>
                {
                    b.HasOne("Aban.Domain.Entities.Corporation", "Corporation")
                        .WithMany("Usuarios")
            ...
            modelBuilder.Entity("Aban.Domain.EntitesSoftSec.UsuarioRole", b =>
                {
                    ...
                    b.HasOne("Aban.Domain.EntitesSoftSec.Usuario", "Usuario")
                        .WithMany("UsuarioRoles")
            ...
            modelBuilder.Entity("Aban.Domain.Entities.Corporation", b =>
                {
                    b.HasOne("Aban.Domain.Entities.Country", "Country")
            ...
            modelBuilder.Entity("Aban.Domain.Entities.UserRoleDetails", b =>
                {
                    b.HasOne("Aban.Domain.Entities.User", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Aban.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
