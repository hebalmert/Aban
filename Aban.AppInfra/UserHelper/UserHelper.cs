...
namespace Aban.AppInfra.UserHelper;
...
public class UserHelper : IUserHelper
{
    ...
    public async Task<User> AddUserUsuarioAsync(string firstname, string lastname, string username,
            string email, string phone, string address, int Idcorporate, string ImagenFull, string Origin, bool UserActivo, UserType usertype)
    {
