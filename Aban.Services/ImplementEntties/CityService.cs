    ...
    public async Task<ActionResponse<IEnumerable<City>>> GetAsync(PaginationDTO pagination)
    {
        try
        {
            ...
            if (!string.IsNullOrWhiteSpace(pagination.Filter))
            {
                ...
                //Latin1_General_CI_AS o que este nivel general de base de datos o se puede obligar pot campo en el ModelConfig de AppInfra.
                //Para que podmos usar EF.Functions.Like, asi no tener que definir manualmente el ToLower o ToUpper y mantener los indices.
